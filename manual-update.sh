...
sed -i '/import CabinsListPage/a import AboutPage from '\''./pages/AboutPage'\'';' src/App.tsx
sed -i '/import CabinsListPage/a import ContactsPage from '\''./pages/ContactsPage'\'';' src/App.tsx
sed -i '/Route path="\/cabin\/:id"/a \        <Route path="/about" element={<AboutPage />} />' src/App.tsx
sed -i '/Route path="\/about"/a \        <Route path="/contacts" element={<ContactsPage />} />' src/App.tsx
